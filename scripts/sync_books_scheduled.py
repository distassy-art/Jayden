#!/usr/bin/env python3
"""Legacy Clients Excel → smartsolutionsai.us books overlay sync.

Prefer scripts/sync_from_s2k.py: S2K Daily Book PDFs are the source of truth for
open-month daily rows. This Excel walker remains for Monthly Summary / ExtraMile
and as a fallback when SoftSP PDFs are unavailable.
