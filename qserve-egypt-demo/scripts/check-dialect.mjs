...
ok("contact drops Camp Sheizar", !contentSrc.includes("كامب شيزار") && !contentSrc.includes("Camp Sheizar") && !contentSrc.includes("Camp Caesar") && !contactSrc.includes("addressAlex") && !contactSrc.includes("mapQueryAlex"));
...
ok("contact has socials and factory map", contactSrc.includes("t.whatsapp") && contactSrc.includes("YouTube") && contactSrc.includes("Facebook") && contactSrc.includes("site.mapQuery"));
...
ok("systems cards use original product thumbs", homeSrc.includes("cardImage") && contentSrc.includes('cardImage: "/photos/queue-bank.webp"') && contentSrc.includes('cardImage: "/photos/nurse-call-product-card.png"') && contentSrc.includes("/photos/nurse-call-banner.png") && contentSrc.includes("/photos/queue-components.png"));
