...
export function SalesmanChat() {
  ...
  function greetVoice() {
    stopVoice.current();
    stopVoice.current = speakWelcome(hello, ar);
    pulseTalk(Math.min(5000, 1600 + hello.length * 18));
  }
  ...
  return (
    <>
      <QaiWanderer ar={ar} open={open} talking={talking} hello={hello} onOpen={openAgent} onDismiss={dismiss} />
      {open && (
        <div className="qai-chat-dock glass" dir={ar ? "rtl" : "ltr"}>
