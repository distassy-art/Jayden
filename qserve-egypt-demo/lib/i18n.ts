...
export const ui = {
  ar: {
    ...
    nursePillars: ["نداء", "محطة تمريض", "استجابة سريعة"] as string[],
    nurseQuoteVia: "اطلب عرض سعر عبر واتساب",
    nurseBenefitsTitle: "فوائد Nurse Call System",
  ...
  en: {
    ...
    nursePillars: ["Call", "Nurse station", "Fast response"] as string[],
    nurseQuoteVia: "Request a quote via WhatsApp",
    nurseBenefitsTitle: "Benefits of the Nurse Call System",
